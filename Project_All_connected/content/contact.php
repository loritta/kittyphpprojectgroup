...
if (isset($_POST['submit'])) {
    ...
    $telephone = (!empty($_POST['phone']) ? $_POST['phone'] : "n/a");
    $comments = $_POST['text'];
    $subject = (!empty($_POST['subject']) ? $_POST['subject'] : "n/a");
...
?>
    ...
    <div class="aboutMain aboutEven">
        ...
        <div class="formFrame notMoving">
            ...
            <h1 class="title textCenter"><?php echo "Mail Sent. Thank you " . $first_name . ", we will contact you shortly. ";?>

    ...
    <div class="tz-gallery">
        <div class="row row-eq-height">
            ...
            <div class="col-sm-6 col-md-4">
                ...
                <div class='thumbnail'>
                    <a href="media/AdoptedCats/_DSC3455.jpg" data-caption="Image caption" caption='test' class='lightbox'>
                        <img src="media/AdoptedCats/_DSC3455.jpg" alt="First image">
                    </a>
                    <div class="caption">
                        <h3>Kitty 1</h3>
            ...
            <div class="col-sm-6 col-md-4">
                <div class='thumbnail'>
                    <a href="media/AdoptedCats/_DSC3491.jpg" class='lightbox'>
                        <img src="media/AdoptedCats/_DSC3491.jpg" alt="Second image">
                    </a>
                    <div class="caption">
                        <h3>Kitty 2</h3>
                        <p></p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class='thumbnail'>
                    <a href="media/AdoptedCats/_DSC3553.jpg" class='lightbox'>
                        <img src="media/AdoptedCats/_DSC3553.jpg" alt="Third image">
                    </a>
                    <div class="caption">
                        <h3>Kitty 3</h3>
                        <p></p>

            ...
            <nav>
                <div id="myNav" class="overlay">
                    ...
                    <div class="overlay-content">
                        ...
                        <div class="right">
                            <a class="navFont" href="order.html">Useful Resources</a>
                ...
                <span style="font-size:30px;cursor:pointer" onclick="openNav()"><img src="paw-prints-clipart-cat-paw.png" desalt="Avatar" class="avatar"></span>
